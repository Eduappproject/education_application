...
class WindowClass(QMainWindow, form_class):
    ...
    def __init__(self):
        ...
        # 회원가입화면 라디오버튼
        self.userCheckButton_1.clicked.connect(self.userCheckButton_1_event)
        self.userCheckButton_2.clicked.connect(self.userCheckButton_2_event)
    ...
    def SignUpPushButton_2_event(self):  # 회원가입 버튼
        self.sock.send(
            f"{self.lineEdit_new_pw_check.text()}"
            f"/{self.lineEdit_new_name.text()}"
            f"/{self.lineEdit_email.text()}"
            f"/{'학생' if self.userCheckButton_1.isChecked() else '교사'}"
            .encode())
        self.sign_up_back()
    ...
    def userCheckButton_1_event(self):
        self.userCheckButton_2.setChecked(False)
        print("self.userCheckButton_1.isChecked()", self.userCheckButton_1.isChecked())
        print("self.userCheckButton_2.isChecked()", self.userCheckButton_2.isChecked())

    def userCheckButton_2_event(self):
        self.userCheckButton_1.setChecked(False)
        print("self.userCheckButton_1.isChecked()", self.userCheckButton_1.isChecked())
        print("self.userCheckButton_2.isChecked()", self.userCheckButton_2.isChecked())
    ...
    def EmailCheckPushButton_event(self):
        ...
        ses.sendmail('PyQt5.ABC@gmail.com', email, msg.as_string())
